...
var FishEgg = function () {
  ...
  _createClass(FishEgg, [{
    key: "createCircle",
    value: function createCircle(x, y, r, c) {
...
var Paramecium = function () {
  ...
  _createClass(Paramecium, [{
    key: "createOval",
    value: function createOval(x, y, w, h) {
      var kappa = .5522848,
          ox = w / 2 * kappa,
...
function clear() {
  ...
  grd.addColorStop(0, "rgba(25,25,54,0.6)");
